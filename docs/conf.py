...
project = 'molecool'
copyright = ("2021, Chris Blais. Project structure based on the "
...
texinfo_documents = [
    (master_doc, 'molecool', 'molecool Documentation',
     author, 'molecool', 'a python package for analyzing and visualizing moleculat files for molSSI workshop',
     'Miscellaneous'),
]
